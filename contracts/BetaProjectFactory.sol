...
import "./BetaProjectTemplate.sol";
import "./BaseProjectFactory.sol";

contract BetaProjectFactory is BaseProjectFactory {
    ...
    {
        BetaProjectTemplate project =
            new BetaProjectTemplate(project_id, symbol, platform, USDT_address);
